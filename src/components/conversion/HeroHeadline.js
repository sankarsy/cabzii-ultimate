...
export default function HeroHeadline({
  title = "Cab booking in Chennai",
  subtitle = "Airport taxi, local packages, outstation and acting driver. Fares shown before you confirm."
}) {
    ...
    <div className="section-shell pb-4 pt-6 sm:pb-5 sm:pt-8">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <a
          ...
          onClick={() => trackLead("whatsapp", { cta_location: "hero_headline" })}
        >
        ...
        <a
          ...
          onClick={() => trackLead("phone", { cta_location: "hero_headline" })}
        >
        ...
        <Link
          ...
          onClick={() => trackEvent("quote_request", { cta_location: "hero_headline" })}
        >
          Search cabs
        </Link>
      </div>
