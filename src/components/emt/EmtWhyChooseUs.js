...
const FEATURES = [
  { iconKey: "verified", title: "Verified partners", desc: "Airlines, hotels & cab vendors you can trust." },
  { iconKey: "price", title: "Best price guarantee", desc: "Compare fares side-by-side before you pay." },
  { iconKey: "secure", title: "Secure checkout", desc: "OTP login and encrypted payment flow." },
  { iconKey: "support", title: "24×7 support", desc: "WhatsApp & phone when you need help on trip." }
];
          ...
          {FEATURES.map((f) => {
            ...
            return (
              <div key={f.title} className="flex items-start gap-3 text-left sm:block sm:text-center">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[var(--cabzii-brand)]/10 text-[var(--cabzii-brand)] sm:mx-auto sm:mb-2 sm:h-12 sm:w-12">
