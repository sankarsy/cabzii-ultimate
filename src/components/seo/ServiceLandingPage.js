  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-slate-50 via-sky-50/60 to-violet-50/40">
      ...
      <article className="mx-auto max-w-4xl px-4 py-10 md:py-14">
              ...
              {cityRoutes.map((route) => (
                <li key={route.slug}>
                  <Link
                    ...
                    className="inline-block rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:border-[#0056D2]/30 hover:text-[#0056D2]"
                  >
        ...
        <section className="mt-10 rounded-2xl bg-[#0056D2] p-6 text-white md:p-8">
          ...
          <Link
            href={searchHref}
            className="mt-4 inline-flex rounded-full bg-white px-5 py-2.5 text-sm font-bold text-[#0056D2] hover:bg-slate-100"
          >
            Search & book now
          </Link>
        </section>
