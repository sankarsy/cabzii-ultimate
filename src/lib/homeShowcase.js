...
export const CITY_SERVICE_CARDS = [
  { tag: "CHENNAI", title: "Cab services in Chennai", desc: "Airport taxi, local hire and outstation cabs with upfront fares.", iconKey: "car", color: "from-[var(--cabzii-brand)] to-blue-500", image: IMG.chennai, href: "/car-rental/chennai-city-cabs", fare: "From ₹1,200" },
  { tag: "BENGALURU", title: "Cab services in Bengaluru", desc: "Airport pickup, city taxi and outstation cabs across Bengaluru.", iconKey: "car", color: "from-indigo-500 to-violet-400", image: IMG.bengaluru, href: "/car-rental/bengaluru-city-cabs", fare: "From ₹999" },
  { tag: "HYDERABAD", title: "Cab services in Hyderabad", desc: "Airport, local and intercity cabs with fares shown before you confirm.", iconKey: "airport", color: "from-emerald-500 to-teal-400", image: IMG.airport, href: "/car-rental/hyderabad-city-cabs", fare: "From ₹899" },
  { tag: "COIMBATORE", title: "Cab services in Coimbatore", desc: "Outstation and local taxi hire for Coimbatore and hill stations.", iconKey: "car", color: "from-amber-500 to-orange-400", image: IMG.outstation, href: "/car-rental/coimbatore-city-cabs", fare: "From ₹799" },
  { tag: "MADURAI", title: "Cab services in Madurai", desc: "Temple tours, airport taxi and outstation cabs in Madurai.", iconKey: "holiday", color: "from-rose-500 to-pink-400", image: IMG.temple, href: "/car-rental/madurai-city-cabs", fare: "From ₹799" },
  { tag: "TRICHY", title: "Cab services in Trichy", desc: "Airport drop, local taxi and one-way cabs from Trichy.", iconKey: "route", color: "from-slate-700 to-slate-500", image: IMG.route, href: "/car-rental/trichy-city-cabs", fare: "From ₹749" },
  { tag: "PONDICHERRY", title: "Cab services in Pondicherry", desc: "Chennai–Pondy one-way, local sightseeing and airport transfers.", iconKey: "car", color: "from-[var(--cabzii-brand)] to-blue-500", image: IMG.chennai, href: "/car-rental/pondicherry-city-cabs", fare: "From ₹999" },
  { tag: "TIRUPATI", title: "Cab services in Tirupati", desc: "Darshan cabs, airport taxi and outstation returns from Tirupati.", iconKey: "holiday", color: "from-rose-500 to-pink-400", image: IMG.temple, href: "/car-rental/tirupati-city-cabs", fare: "From ₹899" },
  { tag: "VELLORE", title: "Cab services in Vellore", desc: "Local taxi, hospital drops and outstation cabs from Vellore.", iconKey: "driver", color: "from-slate-700 to-slate-500", image: IMG.driver, href: "/car-rental/vellore-city-cabs", fare: "From ₹699" },
  { tag: "SALEM", title: "Cab services in Salem", desc: "Tempo Traveller, SUV and sedan hire for Salem trips.", iconKey: "car", color: "from-amber-500 to-orange-400", image: IMG.tempo, href: "/car-rental/salem-city-cabs", fare: "From ₹749" },
  { tag: "RAMESWARAM", title: "Cab services in Rameswaram", desc: "Temple tour cabs and Madurai–Rameswaram one-way packages.", iconKey: "holiday", color: "from-rose-500 to-pink-400", image: IMG.temple, href: "/car-rental/rameswaram-city-cabs", fare: "From ₹999" },
  { tag: "OOTY", title: "Cab services in Ooty", desc: "Hill-station cabs, sightseeing and Coimbatore–Ooty transfers.", iconKey: "car", color: "from-emerald-500 to-teal-400", image: IMG.tempo, href: "/car-rental/ooty-city-cabs", fare: "From ₹1,499" },
  { tag: "KODAIKANAL", title: "Cab services in Kodaikanal", desc: "Scenic hill cabs and Madurai–Kodai taxi packages.", iconKey: "car", color: "from-indigo-500 to-violet-400", image: IMG.outstation, href: "/car-rental/kodaikanal-city-cabs", fare: "From ₹1,499" },
  { tag: "MYSORE", title: "Cab services in Mysore", desc: "Palace city taxi, Bengaluru–Mysore one-way and local hire.", iconKey: "car", color: "from-[var(--cabzii-brand)] to-blue-500", image: IMG.bengaluru, href: "/car-rental/mysore-city-cabs", fare: "From ₹899" },
  { tag: "KOCHI", title: "Cab services in Kochi", desc: "Airport taxi, city cabs and Kerala outstation packages.", iconKey: "airport", color: "from-indigo-500 to-violet-400", image: IMG.airport, href: "/car-rental/kochi-city-cabs", fare: "From ₹899" }
];
