...
export const SEO_CITIES = [
  ...
  { slug: "kanchipuram", name: "Kanchipuram", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "tiruvannamalai", name: "Tiruvannamalai", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "thanjavur", name: "Thanjavur", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "kumbakonam", name: "Kumbakonam", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "palani", name: "Palani", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "chidambaram", name: "Chidambaram", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "kanyakumari", name: "Kanyakumari", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "velankanni", name: "Velankanni", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "thoothukudi", name: "Thoothukudi", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "tiruppur", name: "Tiruppur", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "nagercoil", name: "Nagercoil", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "dindigul", name: "Dindigul", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "karur", name: "Karur", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "villupuram", name: "Villupuram", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "karaikudi", name: "Karaikudi", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "theni", name: "Theni", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "nagapattinam", name: "Nagapattinam", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
  { slug: "thiruchendur", name: "Thiruchendur", state: "Tamil Nadu", region: "IN-TN", langs: ["ta", "en"] },
...
export const CITY_GEO = {
  ...
  palani: { lat: "10.4504", lng: "77.5207" },
  chidambaram: { lat: "11.3993", lng: "79.6954" },
  kanyakumari: { lat: "8.0883", lng: "77.5385" },
  velankanni: { lat: "10.6816", lng: "79.8496" },
  thoothukudi: { lat: "8.7642", lng: "78.1348" },
  tiruppur: { lat: "11.1085", lng: "77.3411" },
  nagercoil: { lat: "8.1784", lng: "77.4348" },
  dindigul: { lat: "10.3673", lng: "77.9803" },
  karur: { lat: "10.9601", lng: "78.0766" },
  villupuram: { lat: "11.9398", lng: "79.4924" },
  karaikudi: { lat: "10.0661", lng: "78.7802" },
  theni: { lat: "10.0104", lng: "77.4768" },
  nagapattinam: { lat: "10.7672", lng: "79.8449" },
  thiruchendur: { lat: "8.4963", lng: "78.119" },
